...
import 'package:scheduler_app_sms/core/provider/users_provider.dart';
...
class _NewAppointmentPageState extends ConsumerState<NewAppointmentPage> {
  ...
  Widget build(BuildContext context) {
    var notifier = ref.read(newAppointmentProvider.notifier);
    var me = ref.watch(userProvider);
    List<String> taskType = ['Personal', 'Work', 'Meeting', 'Study'];
    var provider = ref.watch(newAppointmentProvider);
                            ...
                            children: <Widget>[
                              ...
                              CustomTextFields(
                                ...
                                controller: TextEditingController(
                                  text: ref.watch(newAppointmentProvider).date != 0
                              ...
                              CustomTextFields(
                                ...
                                controller: TextEditingController(
                                  text: ref.watch(newAppointmentProvider).time != 0
                                      ? formatTime(
                              ...
                              CustomButton(
                                ...
                                onPressed: () {
                                  if (form.currentState!.validate()) {
                                    ...
                                    notifier.createApp(context, ref);
                                  }
                                },
                              )
                            ],
